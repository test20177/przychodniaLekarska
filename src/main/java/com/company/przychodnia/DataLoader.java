...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Wiadomosc wiadomosc2 = new Wiadomosc("Zmiana godzin przyjmownia pacjentów", "Informujemy, że w dniu 20 września przychodznia będzie czynna dłużej - do godziny 20.", LocalDateTime.of(2018, 9, 18, 10, 7));
        ...
        Wiadomosc wiadomosc4 = new Wiadomosc("Zmiana godzin przyjmownia pacjentów", "Informujemy, że w dniu 27 września przychodznia będzie czynna dłużej - do godziny 20.", LocalDateTime.of(2018, 9, 24, 7, 52));
